...
import nbs2func.layout.note_stereo as note_stereo
from nbs2func.layout.collision import (
    _Footprint,
    _FootprintOccupancy,
    _footprint_collides,
)
from nbs2func.layout.geometry import above, below
...
from nbs2func.analysis.spatial_analyzer import (
    LayoutSpatialSegmentHint,
    analyze_layout_spatial,
    build_layout_spatial_hint_index,
)
from nbs2func.layout.models import EmitterCandidate, RailRegistry
